...
public class RenderControlManager {
    ...
    private final LinkedHashMap<UnsignedIntegerFourBytes, IRendererInterface.IAVTransportControl> avControlMap = new LinkedHashMap<>();
    private UnsignedIntegerFourBytes[] audioControlUnsignedIntegerFourBytes = null;
    private final LinkedHashMap<UnsignedIntegerFourBytes, IRendererInterface.IAudioControl> audioControlMap = new LinkedHashMap<>();
